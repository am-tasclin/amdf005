...
var initApp = ($scope, $http, $timeout) => {
	ctrl.eMap = {}
...
var initRandom = () => {
	...
	angular.forEach(ctrl.random, (v, k) => random_newValue(k))
}

var random_newValue = (name, valueName) => {
...
sql_app.obj_with_i18n = () => "SELECT d1.*, dr1.doctype doctype_r \n" +
...
class Exe_fn {
	constructor($http) {
		...
		this.httpGet_j2c_table_db1_params_then_fn = (params, then_fn) => {
			return {
